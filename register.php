...
<form action="" method="post" autocomplete="off">
    ...
    <?php //echo escape(Input::get('name')); ?><!--" name="name" id="name" required>-->
    <!--    </div>-->
    <!--    <div class="field">-->
    <!--        <label for="username">Username</label>-->
    <!--        <input type="text" name="username" value="-->
    <?php //echo escape(Input::get('username')); ?><!--" id="username" required>-->
    <!--    </div>-->
    <div class="field">
        <label for="password">Password</label>
        <input type="password" name="password" id="password" value="<?php escape(Input::get('password')) ;?>">
    </div>
    <!--    <div class="field">-->
